package com.example.coffeeshop.aspect;
...
public class LoggingAspect {
    ...
    @AfterReturning(pointcut = "execution(* com.example.coffeeshop..*(..))", returning = "result")
    ...
    @AfterThrowing(pointcut = "execution(* com.example.coffeeshop..*(..))", throwing = "error")
